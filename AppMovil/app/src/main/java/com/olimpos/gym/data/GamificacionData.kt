...
val LOGROS = listOf(
    ...
    Logro("💎", "Racha de titanio", "30 días seguidos entrenando sin cortar la racha", 0f, false),
    ...
    Logro("🥷", "Guerrero de fin de semana", "Entrená sábado y domingo la misma semana", 0f, false),
